...
class NN:
    ...
    def constru_NN(self, images_val, labels_val, images_test, labels_test):
        ...
        optimizer = tf.train.GradientDescentOptimizer(learning_rate) #cannot work
        # optimizer = tf.train.AdamOptimizer(learning_rate) #work
        # optimizer = tf.train.MomentumOptimizer(learning_rate=0.01, momentum=0.99) //result wrong
        ...
        layer1_result_test = tf.nn.relu(tf.add(tf.matmul(images_test/255, w1), b1))
...
nn = NN(images_in[:15000,:], labels_in[:15000,:])
nn.constru_NN(images_in[15000:16000,:],labels_in[15000:16000,:], images_in[16000:18720,:],labels_in[16000:18720,:])
